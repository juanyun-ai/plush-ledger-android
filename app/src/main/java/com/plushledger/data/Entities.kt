...
data class ProfileEntity(
    ...
    @ColumnInfo(name = "province") val province: String? = null,
    @ColumnInfo(name = "city") val city: String? = null,
    @ColumnInfo(name = "account_no") val accountNo: String? = null,
    @ColumnInfo(name = "account_no_changed_month") val accountNoChangedMonth: String? = null,
    @ColumnInfo(name = "account_no_changed_count") val accountNoChangedCount: Int = 0,
