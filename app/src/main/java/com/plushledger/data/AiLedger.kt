...
object LocalAiLedgerParser {
    ...
    private val expenseKeywords = listOf(
        "咖啡" to listOf("咖啡", "奶茶", "茶饮", "瑞幸", "星巴克", "喜茶", "蜜雪", "拿铁", "美式"),
        "早餐" to listOf("早餐", "早饭", "豆浆", "包子"),
        "外卖" to listOf("外卖", "美团", "饿了么"),
        "午餐" to listOf("午餐", "午饭", "中饭", "午间", "食堂", "盖饭", "米线", "面馆"),
        "晚餐" to listOf("晚餐", "晚饭", "晚间", "吃饭", "餐厅", "火锅", "烧烤"),
        "零食" to listOf("零食", "薯片", "饮料"),
        "聚餐" to listOf("聚餐", "团建"),
        "公交地铁" to listOf("公交", "地铁"),
        "打车" to listOf("打车", "滴滴", "出租车"),
        "火车高铁" to listOf("高铁", "火车", "动车"),
        "飞机" to listOf("飞机", "机票", "航班", "机场"),
        "轮渡" to listOf("轮渡", "渡轮", "船票", "客船", "Ferry", "ferry"),
        "买菜" to listOf("买菜", "菜市场", "蔬菜", "水果", "生鲜"),
        "日用百货" to listOf("超市", "百货", "日用"),
        ...
        "生日礼物" to listOf("生日礼物", "生日", "礼物", "蛋糕"),
        "请客送礼" to listOf("送礼", "请客", "红包", "随礼", "份子钱"),
