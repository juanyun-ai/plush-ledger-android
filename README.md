<div align="center">
  ...
  **一款本地优先、可云同步的 3D 毛绒风 Android 记账应用**
  ...
  ![Version](https://img.shields.io/badge/version-0.8.5-FFA126?style=flat-square)
...
微信/QQ 一键登录与自动绑定需要腾讯开放平台 AppID、移动应用审核和回调服务；微信/支付宝自动扣款与自动开通会员需要商户号、服务端下单和支付回调。当前 0.8.5 支持“人工核验会员订单”，不伪造登录、支付或自动读取个人支付账单。
